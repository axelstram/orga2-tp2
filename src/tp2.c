...
#define PROMEDIO "promedio_colors_asm.txt"

#define MINIATURE_TIEMPOS "tiempos_miniature_basura.txt"
#define MINIATURE_TOTALES "tiempos_miniature_basura.txt"

#define COLOR_TIEMPOS "tiempos_colors_asm.txt"
#define COLOR_TOTALES "totales_colors_asm.txt"

#define DECODE_TIEMPOS "tiempos_decode_c.txt"
#define DECODE_TOTALES "totales_decode_c.txt"
...
void aplicar_miniature(const char *implementacion,
    ...
    FILE* f = fopen(MINIATURE_TIEMPOS, "a");
    int iteraciones = 1;
    ...
    FILE* g = fopen(MINIATURE_TOTALES, "a");
	fprintf(g,"%ld\n", total);
    fclose(g);
